...
import com.yunzhanghu.redpacketui.utils.RPRandomPacketUtil;
...
public class DemoUtil {
    ...
    public static void startRandomPacket(RPRandomPacketUtil.RPSmallRandomCallBack callBack, final Fragment fragment, int requestCode) {
        //发送者头像url
        RedPacketInfo redPacketInfo = new RedPacketInfo();
        redPacketInfo.fromNickName = sCurrentNickname;
        redPacketInfo.fromAvatarUrl = sCurrentAvatarUrl;
        ...
        redPacketInfo.toNickName = sToNickname;
        redPacketInfo.toAvatarUrl = sToAvatarUrl;
        RPRandomPacketUtil.getInstance().sendRandomPacket(redPacketInfo, getTokenData(), fragment, requestCode, callBack);
    }
